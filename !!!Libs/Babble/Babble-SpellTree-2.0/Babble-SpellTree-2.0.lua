--[[
Name: Babble-SpellTree-2.0
Revision: $Rev: 14112 $
Author(s): ckknight (ckknight@gmail.com)
Website: http://ckknight.wowinterface.com/
Documentation: http://wiki.wowace.com/index.php/Babble-SpellTree-2.0
SVN: http://svn.wowace.com/root/trunk/BabbleLib/Babble-SpellTree-2.0
Description: A library to provide localizations for spell and talent trees.
Dependencies: AceLibrary, AceLocale-2.0
]]

local MAJOR_VERSION = "Babble-SpellTree-2.0"
...
local BabbleSpellTree = AceLibrary("AceLocale-2.0"):new(MAJOR_VERSION)
