...
BabbleBoss:RegisterTranslations("zhCN", function()
	return {
		...
		["Agathelos the Raging"] = "狂怒的阿迦索罗斯",
		["Blind Hunter"] = "盲眼猎手",
		["Charlga Razorflank"] = "卡尔加·刺肋",
		["Earthcaller Halmgar"] = "唤地者哈穆加",
		["Tuten'kash"] = "图特卡什",
		["Lady Falther'ess"] = "法瑟雷斯女士",
		["Mordresh Fire Eye"] = "火眼莫德雷斯",
		["Glutton"] = "暴食者",
		["Ragglesnout"] = "拉戈斯诺特",
		["Amnennar the Coldbringer"] = "寒冰使者阿曼纳尔",
		...
		["Ironspine"] = "铁脊死灵",
		["Azshir the Sleepless"] = "无眠者埃萨尔",
		["Fallen Champion"] = "堕落的勇士",
		["Lord Blackwood"] = "布莱克伍德",
		["Death Knight Darkreaver"] = "死亡骑士达克雷尔",
		["Kormok"] = "科尔莫克",
		["Skul"] = "斯库尔",
		["Balzaphon"] = "巴尔萨隆",
		["Malor the Zealous"] = "狂热者玛洛",
		["Sothos"] = "索索斯",
		["Jarien"] = "加里恩",
		["Stonespine"] = "石脊",
		["Rhahk'Zor"] = "拉克佐",
		...
		["Edwin VanCleef"] = "埃德温·范克里夫",
		["Mr. Smite"] = "重拳先生",
		["Cookie"] = "曲奇",
		["Targorr the Dread"] = "恐怖的塔格尔",
		["Kam Deepfury"] = "卡姆·深怒",
		["Hamhock"] = "哈姆霍克",
		...
		["Baelog"] = "巴尔洛戈",
		["Eric \"The Swift\""] = "迅捷的埃里克",
		["Olaf"] = "奥拉夫",
		["Revelosh"] = "瑞沃罗什",
		["Ironaya"] = "艾隆纳亚",
		["Obsidian Sentinel"] = "黑曜石哨兵",
		["Ancient Stone Keeper"] = "远古石刻守护者",
