...
function CCWatchOptionsWarnCCDropDown_OnInit()
	...
	info.text = CCWATCH_OPTIONS_EMOTE;
	info.value = "EMOTE";
	info.owner = this;
	info.func = CCWatchOptionsWarnCCDropDown_OnClick;
	UIDropDownMenu_AddButton(info);

	info.text = CCWATCH_OPTIONS_SAY;
	info.value = "SAY";
	info.owner = this;
	info.func = CCWatchOptionsWarnCCDropDown_OnClick;
	UIDropDownMenu_AddButton(info);
	
	info.text = CCWATCH_OPTIONS_PARTY;
	info.value = "PARTY";
	info.owner = this;
	info.func = CCWatchOptionsWarnCCDropDown_OnClick;
	UIDropDownMenu_AddButton(info);

	info.text = CCWATCH_OPTIONS_RAID;
	info.value = "RAID";
	info.owner = this;
	info.func = CCWatchOptionsWarnCCDropDown_OnClick;
	UIDropDownMenu_AddButton(info);

	info.text = CCWATCH_OPTIONS_YELL;
	info.value = "YELL";
	info.owner = this;
	info.func = CCWatchOptionsWarnCCDropDown_OnClick;
	UIDropDownMenu_AddButton(info);

	info.text = CCWATCH_OPTIONS_CHANNEL;
	info.value = "CHANNEL";
	info.owner = this;
	info.func = CCWatchOptionsWarnCCDropDown_OnClick;
	UIDropDownMenu_AddButton(info);
...
function CCWatchOptionsEffectTypeDropDown_OnInit()
	...
	info.text = CCWATCH_OPTIONS_CC;
	info.value = "cc";
	info.owner = this;
	info.func = CCWatchOptionsEffectTypeDropDown_OnClick;
	UIDropDownMenu_AddButton(info);

	info.text = CCWATCH_OPTIONS_DEBUFF;
	info.value = "debuff";
	info.owner = this;
	info.func = CCWatchOptionsEffectTypeDropDown_OnClick;
	UIDropDownMenu_AddButton(info);
	
	info.text = CCWATCH_OPTIONS_BUFF;
	info.value = "buff";
	info.owner = this;
	info.func = CCWatchOptionsEffectTypeDropDown_OnClick;
	UIDropDownMenu_AddButton(info);
...
function CCWatchOptionsEffectTypeDropDown_OnClick()
	if (this.value == "cc") then
		CCWatchOptionsEffectTypeDropDownText:SetText(CCWATCH_OPTIONS_CC);
	elseif( this.value == "debuff" ) then
		CCWatchOptionsEffectTypeDropDownText:SetText(CCWATCH_OPTIONS_DEBUFF);
	elseif( this.value == "buff" ) then
		CCWatchOptionsEffectTypeDropDownText:SetText(CCWATCH_OPTIONS_BUFF);
	end
end
...
function CCWatchOptionsLearnClear_OnClick()
	...
	CCWatchOptionsLearnModify:SetText(CCWATCH_ADD);
	bModify = false;
...
function CCWatchOptionsLearnFillFields()
	...
	bModify = true;
	CCWatchOptionsLearnModify:SetText(CCWATCH_MODIFY);
end
