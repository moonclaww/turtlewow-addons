...
ClockFu.version = "2.0." .. string.sub("$Revision: 14726 $", 12, -3)
ClockFu.date = string.sub("$Date: 2006-10-21 20:56:54 -0400 (Sat, 21 Oct 2006) $", 8, 17)
...
ClockFu:RegisterChatCommand(L["AceConsole-commands"], optionsTable)
