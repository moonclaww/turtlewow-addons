...
local function Gatherer_IsTurtleWoW()
	local zoneNames = {GetMapZones(1)};
	return table.getn(zoneNames) >= 24;
end

local isTurtleWoW = Gatherer_IsTurtleWoW();

-- TurtleWoW zone mappings (different zone numbering than vanilla)
-- Maps TurtleWoW zone IDs to the correct geographic coordinates
if isTurtleWoW then
	-- Kalimdor (Continent 1) - TurtleWoW has 31 zones
	GatherRegionData[1][0]  = { name = "Kalimdor" };
	-- Zone 1: GM Island (TurtleWoW custom - no geographic data)
	-- Zone 2: Winterspring (vanilla zone 21)
	GatherRegionData[1][2]  = { scale = 0.19293573573141, xoffset = 0.47237382938446, yoffset = 0.17390990272233, name = "Winterspring" };
	-- Zone 3: Frostpoint (TurtleWoW custom - no geographic data)
	-- Zone 4: Desolace (vanilla zone 5)
	GatherRegionData[1][4]  = { scale = 0.12219839120669, xoffset = 0.34873187115693, yoffset = 0.50331046935371, name = "Desolace" };
	-- Zone 5: Thousand Needles (vanilla zone 18)
	GatherRegionData[1][5]  = { scale = 0.11956582877920, xoffset = 0.47554411191734, yoffset = 0.68342356389650, name = "ThousandNeedles" };
	-- Zone 6: Dire Maul (dungeon - no world map data)
	-- Zone 7: Wailing Caverns (dungeon - no world map data)
	-- Zone 8: Tanaris (vanilla zone 15)
	GatherRegionData[1][8]  = { scale = 0.18750104661175, xoffset = 0.46971301480866, yoffset = 0.76120931364891, name = "Tanaris" };
	-- Zone 9: Orgrimmar (vanilla zone 12)
	GatherRegionData[1][9]  = { scale = 0.03811449638057, xoffset = 0.56378554142668, yoffset = 0.42905218646258, name = "Ogrimmar" };
	-- Zone 10: Gates of Ahn'Qiraj (no world map data)
	-- Zone 11: Un'Goro Crater (vanilla zone 20)
	GatherRegionData[1][11] = { scale = 0.10054401185671, xoffset = 0.44927594451520, yoffset = 0.76494573629405, name = "UngoroCrater" };
	-- Zone 12: Dustwallow Marsh (vanilla zone 7)
	GatherRegionData[1][12] = { scale = 0.14266384095509, xoffset = 0.49026338351379, yoffset = 0.60461876174686, name = "Dustwallow" };
	-- Zone 13: Silithus (vanilla zone 13)
	GatherRegionData[1][13] = { scale = 0.09468465888932, xoffset = 0.39731975488374, yoffset = 0.76460608512626, name = "Silithus" };
	-- Zone 14: Caverns of Time (TurtleWoW custom - no geographic data)
	-- Zone 15: Moonglade (vanilla zone 10)
	GatherRegionData[1][15] = { scale = 0.06292695969921, xoffset = 0.50130287793373, yoffset = 0.17560823085517, name = "Moonglade" };
	-- Zone 16: Durotar (vanilla zone 6)
	GatherRegionData[1][16] = { scale = 0.14368294970080, xoffset = 0.51709782709100, yoffset = 0.44802818134926, name = "Durotar" };
	-- Zone 17: Telabim (TurtleWoW custom - no geographic data)
	-- Zone 18: Teldrassil (vanilla zone 16)
	GatherRegionData[1][18] = { scale = 0.13836131003639, xoffset = 0.36011098024729, yoffset = 0.03948322979210, name = "Teldrassil" };
	-- Zone 19: Mount Hyjal (TurtleWoW custom - no geographic data)
	-- Zone 20: Ashenvale (vanilla zone 1)
	GatherRegionData[1][20] = { scale = 0.15670371525706, xoffset = 0.41757282062541, yoffset = 0.33126468682991, name = "Ashenvale" };
	-- Zone 21: Maraudon (dungeon - no world map data)
	-- Zone 22: Stonetalon Mountains (vanilla zone 14)
	GatherRegionData[1][22] = { scale = 0.13272833611061, xoffset = 0.37556627748617, yoffset = 0.40285135292988, name = "StonetalonMountains" };
	-- Zone 23: Azshara (vanilla zone 2)
	GatherRegionData[1][23] = { scale = 0.13779501505279, xoffset = 0.55282036918049, yoffset = 0.30400571307545, name = "Aszhara" };
	-- Zone 24: Mulgore (vanilla zone 11)
	GatherRegionData[1][24] = { scale = 0.13960673216274, xoffset = 0.40811854919226, yoffset = 0.53286226907346, name = "Mulgore" };
	-- Zone 25: Feralas (vanilla zone 9)
	GatherRegionData[1][25] = { scale = 0.18885970960818, xoffset = 0.31589651244686, yoffset = 0.61820581746798, name = "Feralas" };
	-- Zone 26: The Barrens (vanilla zone 17)
	GatherRegionData[1][26] = { scale = 0.27539211944292, xoffset = 0.39249347333450, yoffset = 0.45601063260257, name = "Barrens" };
	-- Zone 27: Felwood (vanilla zone 8)
	GatherRegionData[1][27] = { scale = 0.15625084006464, xoffset = 0.41995800144849, yoffset = 0.23097545880609, name = "Felwood" };
	-- Zone 28: Darnassus (vanilla zone 4)
	GatherRegionData[1][28] = { scale = 0.02876626176374, xoffset = 0.38392150175204, yoffset = 0.10441296545475, name = "Darnassis" };
	-- Zone 29: Thunder Bluff (vanilla zone 19)
	GatherRegionData[1][29] = { scale = 0.02836291430658, xoffset = 0.44972878210917, yoffset = 0.55638479002362, name = "ThunderBluff" };
	-- Zone 30: Darkshore (vanilla zone 3)
	GatherRegionData[1][30] = { scale = 0.17799008894522, xoffset = 0.38383175154516, yoffset = 0.18206216123156, name = "Darkshore" };
	-- Zone 31: Blackrock Isle (TurtleWoW custom - no geographic data)

	-- Eastern Kingdoms (Continent 2) - TurtleWoW has 39 zones
	GatherRegionData[2][0]  = { name = "Azeroth" };
	-- Zone 1: Eastern Plaguelands (vanilla zone 9)
	GatherRegionData[2][1]  = { scale = 0.10996723642661, xoffset = 0.51663255550387, yoffset = 0.15624753972085, name = "EasternPlaguelands" };
	-- Zone 2: Scarlet Enclave (TurtleWoW custom - no geographic data)
	-- Zone 3: Dun Morogh (vanilla zone 7)
	GatherRegionData[2][3]  = { scale = 0.13991525534426, xoffset = 0.40335096278072, yoffset = 0.48339696712179, name = "DunMorogh" };
	-- Zone 4: Cold Coast (TurtleWoW custom - no geographic data)
	-- Zone 5: Northwind Cleft (TurtleWoW custom - no geographic data)
	-- Zone 6: Gillijim's Isle (TurtleWoW custom - no geographic data)
	-- Zone 7: Gilneas (TurtleWoW custom - no geographic data)
	-- Zone 8: Alterac Mountains (vanilla zone 1)
	GatherRegionData[2][8]  = { scale = 0.07954563533736, xoffset = 0.43229874660542, yoffset = 0.25425926375262, name = "Alterac" };
	-- Zone 9: Uldaman (dungeon - no world map data)
	-- Zone 10: Balo (TurtleWoW custom - no geographic data)
	-- Zone 11: Hillsbrad Foothills (vanilla zone 11)
	GatherRegionData[2][11] = { scale = 0.09090931690055, xoffset = 0.42424361247460, yoffset = 0.30113436864162, name = "Hilsbrad" };
	-- Zone 12: Undercity (vanilla zone 22)
	GatherRegionData[2][12] = { scale = 0.02727719546939, xoffset = 0.42973999245660, yoffset = 0.23815358517831, name = "Undercity" };
	-- Zone 13: Swamp of Sorrows (vanilla zone 19)
	GatherRegionData[2][13] = { scale = 0.06516347991404, xoffset = 0.51769795272070, yoffset = 0.72815974701615, name = "SwampOfSorrows" };
	-- Zone 14: Lapidis Isle (TurtleWoW custom - no geographic data)
	-- Zone 15: Tirisfal Glades (vanilla zone 21)
	GatherRegionData[2][15] = { scale = 0.12837403412087, xoffset = 0.36837217317549, yoffset = 0.15464954319582, name = "Tirisfal" };
	-- Zone 16: Duskwood (vanilla zone 8)
	GatherRegionData[2][16] = { scale = 0.07670475476181, xoffset = 0.43087243362495, yoffset = 0.73224350550454, name = "Duskwood" };
	-- Zone 17: Stormwind City (vanilla zone 17)
	GatherRegionData[2][17] = { scale = 0.03819701270887, xoffset = 0.41531450060561, yoffset = 0.67097280492581, name = "Stormwind" };
	-- Zone 18: Deadmines (dungeon - no world map data)
	-- Zone 19: Loch Modan (vanilla zone 13)
	GatherRegionData[2][19] = { scale = 0.07839152145224, xoffset = 0.51118749188138, yoffset = 0.50940913489577, name = "LochModan" };
	-- Zone 20: Wetlands (vanilla zone 25)
	GatherRegionData[2][20] = { scale = 0.11745423014662, xoffset = 0.46561438951659, yoffset = 0.40971063365152, name = "Wetlands" };
	-- Zone 21: Searing Gorge (vanilla zone 15)
	GatherRegionData[2][21] = { scale = 0.06338794005823, xoffset = 0.46372051266487, yoffset = 0.57812379382509, name = "SearingGorge" };
	-- Zone 22: Burning Steppes (vanilla zone 5)
	GatherRegionData[2][22] = { scale = 0.08321525646393, xoffset = 0.04621224670174, yoffset = 0.61780780524905, name = "BurningSteppes" };
	-- Zone 23: Elwynn Forest (vanilla zone 10)
	GatherRegionData[2][23] = { scale = 0.09860350595046, xoffset = 0.41092682316676, yoffset = 0.65651531970162, name = "Elwynn" };
	-- Zone 24: Stranglethorn Vale (vanilla zone 18)
	GatherRegionData[2][24] = { scale = 0.18128603034401, xoffset = 0.39145470225916, yoffset = 0.79412224886668, name = "Stranglethorn" };
	-- Zone 25: Badlands (vanilla zone 3)
	GatherRegionData[2][25] = { scale = 0.07066771883566, xoffset = 0.51361415033147, yoffset = 0.56915717993261, name = "Badlands" };
	-- Zone 26: Salas Highlands (TurtleWoW custom - no geographic data)
	-- Zone 27: Scarlet Monastery (dungeon - no world map data)
	-- Zone 28: Western Plaguelands (vanilla zone 23)
	GatherRegionData[2][28] = { scale = 0.12215946583965, xoffset = 0.44270955019641, yoffset = 0.17471356786018, name = "WesternPlaguelands" };
	-- Zone 29: Westfall (vanilla zone 24)
	GatherRegionData[2][29] = { scale = 0.09943208435841, xoffset = 0.36884571674582, yoffset = 0.71874918595783, name = "Westfall" };
	-- Zone 30: Blasted Lands (vanilla zone 4)
	GatherRegionData[2][30] = { scale = 0.09517074521836, xoffset = 0.48982154167011, yoffset = 0.76846519986510, name = "BlastedLands" };
	-- Zone 31: Gnomeregan (dungeon - no world map data)
	-- Zone 32: Redridge Mountains (vanilla zone 14)
	GatherRegionData[2][32] = { scale = 0.06170112311456, xoffset = 0.49917278340928, yoffset = 0.68359285304999, name = "Redridge" };
	-- Zone 33: The Hinterlands (vanilla zone 20)
	GatherRegionData[2][33] = { scale = 0.10937523495111, xoffset = 0.49929119700867, yoffset = 0.25567971676068, name = "Hinterlands" };
	-- Zone 34: Deadwind Pass (vanilla zone 6)
	GatherRegionData[2][34] = { scale = 0.07102298961531, xoffset = 0.47822105868635, yoffset = 0.73863555048516, name = "DeadwindPass" };
	-- Zone 35: Ironforge (vanilla zone 12)
	GatherRegionData[2][35] = { scale = 0.02248317426784, xoffset = 0.47481923366335, yoffset = 0.51289242617182, name = "Ironforge" };
	-- Zone 36: Silverpine Forest (vanilla zone 16)
	GatherRegionData[2][36] = { scale = 0.11931848806212, xoffset = 0.35653502290090, yoffset = 0.24715695496522, name = "Silverpine" };
	-- Zone 37: Alsarath (TurtleWoW custom - no geographic data)
	-- Zone 38: Arathi Highlands (vanilla zone 2)
	GatherRegionData[2][38] = { scale = 0.10227310921644, xoffset = 0.47916793249546, yoffset = 0.32386170078419, name = "Arathi" };
	-- Zone 39: Blackrock Mountain (no world map data)

-- table modified for french locale
elseif ( GetLocale() == "frFR" ) then -- 1.8.0 WoW patch values
