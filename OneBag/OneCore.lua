--$Id: OneCore.lua 19950 2006-12-11 01:44:34Z kaelten $
...
local LC = AceLibrary("AceLocale-2.2"):new("OneCore")
...
function OneCore:LoadLocaleCommands(baseArgs, module, bL)
    ...
    for k in bL:IterateAvailableLocales() do 
    ...
    baseArgs.args.Locale = {
        ...
        get  = function() return self.db.profile.locale or "enUS" end, 
        set  = function(value)
