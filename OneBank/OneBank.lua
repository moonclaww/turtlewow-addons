--$Id: OneBank.lua 19631 2006-12-08 22:23:24Z roartindon $
OneBank = OneCore:NewModule("OneBank", "AceEvent-2.0", "AceHook-2.1", "AceDebug-2.0", "AceConsole-2.0", "AceDB-2.0")
local L = AceLibrary("AceLocale-2.2"):new("OneBank")
...
function OneBank:OnEnable()
	...
	self:SecureHook("PurchaseSlot", function() self.bagPurchased = true end)
    self:SecureHook("CloseBankFrame", function() self.frame:Hide() end)
